...
def zad2_two_layer_net(student_id):
    ...
    class SimpleTwoLayerNetwork:
        def __init__(self, n_in, n_hidden, n_out):
            ...
            self.output_layer = DenseLayer(n_in, n_out, hardlim)
    ...
    model.hidden_layer.W[:, 0] = [-5, 1]      # wagi neuronu h1
    model.hidden_layer.W[:, 1] = [5, -1]      # wagi neuronu h2
    model.hidden_layer.b[:] = [0.5, -3.5]         # biasy neuronów h1 i h2
    model.output_layer.W[:, 0] = [3, 3]      # wagi neuronu wyjściowego
    model.output_layer.b[:] = [-1]  # bias neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    student_id = 198421         # Twój numer indeksu, np. 102247
